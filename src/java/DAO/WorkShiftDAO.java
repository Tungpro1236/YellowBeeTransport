...
public class WorkShiftDAO extends DBContext {
    ...
    private WorkShift mapResultSetToWorkShift(ResultSet rs) throws SQLException {
        ...
        shift.setShiftDate((jdk.jfr.Timestamp) rs.getTimestamp("ShiftDate"));
        shift.setStartTime((jdk.jfr.Timestamp) rs.getTimestamp("StartTime"));
        shift.setEndTime((jdk.jfr.Timestamp) rs.getTimestamp("EndTime"));
